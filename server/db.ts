...
import type { User, Extraction, ShopifySearch } from "@shared/schema";
...
async function connectToDatabase() {
  if (db) return { db, users, extractions, shopifySearches };
  ...
  return { db, users, extractions, shopifySearches };
}
